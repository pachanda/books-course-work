import 'package:books_cw1/src/features/auth/application/token_service.dart';
import 'package:books_cw1/src/shared/dio.dart';
import 'package:dio/dio.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';

class BooksApiSource {
  BooksApiSource(
    Dio dio,
    CurrentToken token
  ) : _dio = dio, 
...
final booksApiSourceProvider = Provider((ref) {
  CurrentToken token = ref.watch(currentTokenProvider);
  Dio dio = ref.watch(dioProvider);
  return BooksApiSource(dio, token);
});